            ...
            <div className="character-sheet-stat-container">
                ...
                <div className="two-stats">
                    <div className="character-sheet-stat">
                        ...
                        <h2 className="stat-number" data-number={character.str} data-stat="STR" id="str">{character.str}</h2>
                    ...
                    <div className="character-sheet-stat">
                        ...
                        <h2 className="stat-number" data-number={character.dex} data-stat="DEX" id="dex">{character.dex}</h2>
                ...
                <div className="two-stats">
                    <div className="character-sheet-stat">
                        ...
                        <h2 className="stat-number" data-number={character.int} data-stat="INT" id="int">{character.int}</h2>
                    ...
                    <div className="character-sheet-stat">
                        ...
                        <h2 className="stat-number" data-number={character.wis} data-stat="WIS" id="wis">{character.wis}</h2>
                ...
                <div className="two-stats">
                    <div className="character-sheet-stat">
                        ...
                        <h2 className="stat-number" data-number={character.con} data-stat="CON" id="con">{character.con}</h2>
                    ...
                    <div className="character-sheet-stat">
                        ...
                        <h2 className="stat-number" data-number={character.cha} data-stat="CHA" id="cha">{character.cha}</h2>
