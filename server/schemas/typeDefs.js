...
const typeDefs = gql`
    ...
    type Mutation {
        ...
        addCharacter(playbook: String, background: String, drive: String, origin: String, name: String, str: String, dex: String, int: String, wis: String, con: String, cha: String, maxHP: String, currentHP: String, damage: String, level: String, exp: String, armor: String, image: String): Character
